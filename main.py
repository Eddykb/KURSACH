...
def start(message):
    ...
    botTimeWeb.send_message(message.chat.id,
                            text="Приветик, {0.first_name}! \nДавай начнем тренировку?".format(message.from_user),
                            reply_markup=markup)
...
def func(message):
    if (message.text == "Поздороваться"):
        botTimeWeb.send_message(message.chat.id,
                                text="Привет! Готова к хорошей тренировке? Напиши да, когда будешь готова)\nЕсли будут вопросы, напиши ?")
    elif (
            message.text == "Начать тренировку" or message.text == "да" or message.text == "давай" or message.text == "Да"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        btn1 = types.KeyboardButton("Пилатес")
        btn2 = types.KeyboardButton("Растяжка")
        back = types.KeyboardButton("Вернуться в главное меню")
        markup.add(btn1, btn2, back)
        botTimeWeb.send_message(message.chat.id, text="Выбирай тип тренировки и нажимай на нужную кнопку)",
                                reply_markup=markup)

    elif (message.text == "Пилатес" or message.text == "пилатес"):
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=AjWoaUBe80c&ab_channel=BaileyBrown"))
        botTimeWeb.send_message(message.chat.id, mess6, reply_markup=markup)
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=toOhNs85Mj8&ab_channel=BaileyBrown"))
        botTimeWeb.send_message(message.chat.id, mess7, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=ucW3ygyzgaI&ab_channel=BaileyBrown"))
        botTimeWeb.send_message(message.chat.id, mess8, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=N2yVhRKMApY&ab_channel=BaileyBrown"))
        botTimeWeb.send_message(message.chat.id, mess9, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=BnSxAiSd7lA&ab_channel=BaileyBrown"))
        ...
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=s-7lyvblFNI&ab_channel=MadyMorrison"))
        botTimeWeb.send_message(message.chat.id, mess1, reply_markup=markup)
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=2eA2Koq6pTI&ab_channel=MadyMorrison"))
        botTimeWeb.send_message(message.chat.id, mess2, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=VcE3SFyHGAw&ab_channel=%D0%94%D0%B5%D0%BB%D0%B0%D0%B9%D0%A2%D0%B5%D0%BB%D0%BE"))
        botTimeWeb.send_message(message.chat.id, mess3, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=ihba9Lw0tv4&ab_channel=MadyMorrison"))
        botTimeWeb.send_message(message.chat.id, mess4, reply_markup=markup)

        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Вперед!",
                                              url="https://www.youtube.com/watch?v=yqeirBfn2j4&ab_channel=MadyMorrison"))
        ...
        botTimeWeb.send_message(message.chat.id,
                                text="Если хочешь начать тренировку - напиши Да, если хочешь расслабиться и дать своим мышщам отдохнуть, напиши - растяжка, если хочешь укрепить и накачать мышщы, напиши - пилатес) ")
    else:
